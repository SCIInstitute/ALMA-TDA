...
import usf.saav.common.mvc.swing.TGLPanel;
import usf.saav.common.mvc.swing.TGraphics;

public abstract class DefaultGLPanel extends TGLPanel {

	private static final long serialVersionUID = 6120892868631646673L;
	...
	protected DefaultGLPanel( int width, int height ){ 
		super( width, height );
		graphics = new Graphics( profile, width, height );
		setGraphics(graphics);
	}
	
	protected DefaultGLPanel( int width, int height, boolean verbose ){ 
		super( width, height );
		graphics = new Graphics( profile, width, height );
		setGraphics(graphics);
